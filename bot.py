...
def getAboutEmbed():
    embed = discord.Embed(title="Parrot",color=0x0000ff, description="I built this bot using the [ElevenLabs](https://beta.elevenlabs.io/) and [OpenAi](https://platform.openai.com/) APIs. Contact me <@273300302541881344> if you have any questions, suggestions or find any bugs.")
